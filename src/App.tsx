            ...
            <main className="flex flex-col items-center min-h-screen py-6 md:py-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
                <section className="flex flex-col md:flex-row items-center justify-between w-full rounded-3xl p-6 md:p-12 dark:bg-gray-900 transition-colors duration-300 gap-8 md:gap-0">
                    <div className="flex-1 pr-0 md:pr-8 text-center md:text-left">
                        ...
                        <p className="text-xl md:text-2xl font-poppins text-gray-500 dark:text-gray-300 mb-6 md:mb-8">
                            Laissez-nous vous sauver la face.
                        </p>
                        <button type="submit" className="w-full md:w-auto bg-fuchsia-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl cursor-pointer hover:bg-fuchsia-700 font-poppins font-medium text-lg md:text-xl transition dark:bg-fuchsia-700 dark:hover:bg-fuchsia-800">
                            Générer une excuse
                        </button>
                    </div>
                ...
                <section className="flex flex-col md:flex-row items-center justify-between w-full rounded-3xl p-6 md:p-12 dark:bg-gray-900 transition-colors duration-300">
                    <div className="flex-1 pr-0 md:pr-8 text-center md:text-left">
                        <h1 className="text-3xl md:text-5xl font-bold font-poppins mb-6 md:mb-8 leading-tight text-gray-900 dark:text-white">"La meilleure solution pour éviter les responsabilités"</h1>
                        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 mb-6 md:mb-8">
                            <img src={img2} alt="avatar" className="w-16 h-16 object-cover rounded-full border-2 border-gray-300 dark:border-gray-700"/>
                            <p className="text-gray-600 dark:text-gray-300 font-bold underline mt-5">Dimitri C. - Developer</p>
                        </div>
                        <button type="submit" className="w-full md:w-auto bg-fuchsia-600 text-white px-6 md:px-8 py-3 md:py-4 rounded-2xl cursor-pointer hover:bg-fuchsia-700 font-poppins font-medium text-lg md:text-xl transition dark:bg-fuchsia-700 dark:hover:bg-fuchsia-800">
                            Commencer
                        </button>
